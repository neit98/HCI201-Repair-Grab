...
public class ViewDetailErrorActivity extends AppCompatActivity {

    private VideoView videoView;
    private MediaController mediaController;
    private Dialog baogiaDialog, tuchoiDialog;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_detail_error);

        Toolbar toolbar = findViewById(R.id.toolbar_detail_error_view);
        ...
        videoView = findViewById(R.id.video_view_view);
        if (mediaController == null) {
            mediaController = new MediaController(ViewDetailErrorActivity.this);
        ...
        tuchoiDialog = new Dialog(this);
        tuchoiDialog.setContentView(R.layout.dialog_canhbao);
        tuchoiDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));

        Button cannhac = tuchoiDialog.findViewById(R.id.btn_xemchitiet);
        cannhac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tuchoiDialog.cancel();
            }
        ...
        Button tuchoi = tuchoiDialog.findViewById(R.id.btn_deny);
    ...
    public void acceptRepairView(View view) {
        baogiaDialog.show();
    }
}
